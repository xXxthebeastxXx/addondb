...
echo "<br /><br />";
echo "<div align='right'><a href='".INFUSIONS."addondb/submission_guidelines.php' title=''>".$locale['tsg030']."</a></div><br /><br /><hr /></div>";
...
echo "<ul>";
    ...
    echo "<img src='".INFUSIONS."addondb/img/header_info_trans.jpg' width='462' alt ='' /><br /><br />\n";
...
echo "<ul>";
	...
	echo "</tr><tr>";
	echo "<td align='center'><img src='".INFUSIONS."addondb/img/folder_tree1.jpg' width=216' alt ='' /></td><td align='center'><img src='".INFUSIONS."addondb/img/folder_tree2.jpg' width=207' alt ='' /></td>";
	echo "</tr><tr>";
	echo "<td class='tbl1' align='center'><b>".$locale['tsg025']."</b></td><td class='tbl1' align='center'><b>".$locale['tsg026']."</b></td>";
	echo "</tr><tr>";
	echo "<td align='center'><img src='".INFUSIONS."addondb/img/t_user_field_tree.jpg' width=238' alt ='' /></td><td align='center'><img src='".INFUSIONS."addondb/img/t_bbcode_tree.jpg' width=245' alt ='' /></td>";
	echo "</tr>\n</table>\n";
	...
	echo "<br />\n";
    echo "".$locale['tsg029']." <img src='".INFUSIONS."addondb/img/translate.png' width='37' alt ='' />\n";
    if (iMEMBER) {
