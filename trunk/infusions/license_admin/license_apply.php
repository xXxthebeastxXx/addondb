...
// Delete after testing
        ...
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl1' valign='top'>".$locale['pla_112']."</td>";
        echo "<td class='tbl1' valign='top'>".$userdata['user_name']."</td>";
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl1' valign='top'>".$locale['pla_140']."</td>";
        echo "<td class='tbl1' valign='top'><input type='textbox' class='textbox' name='app_realname' style='width:300px;'></td>";
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl1' valign='top'>".$locale['pla_117']."</td>";
        echo "<td class='tbl1' valign='top'><input type='textbox' class='textbox' name='app_url' style='width:300px;'></td>";
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl1'>".$locale['pla_109']."</td>";
        echo "<td class='tbl1' nowrap valign='top'>";
    	echo "<select name='app_type' class='textbox'>\n";
    	echo "<option value='0'>".$locale['pla_110']."</option>\n";
    	echo "<option value='1'>".$locale['pla_106']."</option>\n";
    	echo "<option value='2'>".$locale['pla_107']."</option>\n";
    	echo "<option value='3'>".$locale['pla_114']."</option>\n";
    	echo "</select>\n</td>\n";
	    echo "</tr>\n<tr>\n";
        echo "<td class='tbl1' valign='top'>".$locale['pla_113']."</td>";
        ...
        echo "<input type='hidden' class='textbox' name='app_status' value='1' />\n";
        echo "</tr>\n</table>\n</form>\n<br />\n";
...
closetable();
        ...
        $time = time();
        $dev_apply = dbquery("INSERT INTO ".DB_LICENSE_APPLY." VALUES('', '".$userdata['user_id']."', '".$_POST['app_realname']."', '".$_POST['app_type']."', '".stripinput($_POST['app_url'])."', '".stripinput($_POST['app_text'])."', '".$_POST['app_status']."', '$time', '', '', '')");
