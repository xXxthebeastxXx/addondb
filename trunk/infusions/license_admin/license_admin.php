...
if (isset($_GET['status'])) {
	...
	if ((isset($_GET['action']) && $_GET['action'] == "edit") && (isset($_GET['app_id']) && isnum($_GET['app_id']))) {
		...
		if (dbrows($result)) {
			...
			$app_app_company_name = $data['app_company_name'];
			$app_app_company_address = $data['app_company_address'];
			$app_company_phone = $data['app_company_phone'];
			$app_vat = $data['app_vat'];
			$app_bill_name = $data['app_bill_name'];
			$app_bill_email = $data['app_bill_email'];
			$app_tech_name = $data['app_tech_name'];
			$app_tech_email = $data['app_tech_email'];
	...
	opentable($form_title);
        ...
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl1' align='right' valign='top' width='20%'>".$locale['pla_144'].":</td>";
        echo "<td class='tbl1'>".$data['app_address']."<br />".$data['app_country']."</td>";
        echo "</tr>\n<tr>\n";
        
        echo "<td class='tbl1' align='right' width='20%'>".$locale['pla_150'].":</td>";
        echo "<td class='tbl1'>".$data['app_phone']."</td>";
        echo "</tr>\n<tr>\n";
        ...
        echo "<td class='tbl1'>".$data['app_company_name']."</td>";
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl1' align='right' width='20%'>".$locale['pla_149'].":</td>";
        echo "<td class='tbl1'>".$data['app_company_address']."</td>";
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl1' align='right' width='20%'>".$locale['pla_150'].":</td>";
        echo "<td class='tbl1'>".$data['app_company_phone']."</td>";
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl1' align='right' width='20%'>".$locale['pla_143'].":</td>";
        echo "<td class='tbl1'>".$data['app_vat']."</td>";
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl1' align='right' width='20%'>".$locale['pla_145'].":</td>";
        echo "<td class='tbl1'>".$data['app_bill_name']."</td>";
        echo "</tr>\n<tr>\n";
