...
add_to_title($locale['global_200'].$locale['pla_001'].$locale['global_200'].$locale['pla_108']);
...
<p>IMPORTANT: THIS SOFTWARE IS LICENSED, NOT SOLD. Please read the following License Agreement ("License") carefully. This License is between (Your company, or equivalent, name here), copyright (copyright holders name here, ("Licensor"), and the customer ("Licensee" OR "YOU").</p>
<p>BY INSTALLING ALL OR ANY PORTION OF THE SOFTWARE (OR AUTHORIZING ANY OTHER PERSON TO DO SO) , YOU ACCEPT ALL THE TERMS AND CONDITIONS OF THIS LICENSE. IF YOU ACQUIRED THE SOFTWARE WITHOUT AN OPPORTUNITY TO REVIEW THIS LICENSE AND DO NOT ACCEPT THE LICENSE, YOU MAY OBTAIN A REFUND OF THE AMOUNT YOU ORIGINALLY PAID FOR THE SOFTWARE IF YOU: (A) DO NOT USE THE SOFTWARE AND (B) RETURN THE SOFTWARE, WITH PROOF OF PAYMENT, WITHIN THIRTY (30) DAYS OF THE PURCHASE DATE.</p>
<h2>This is the Enduser PHP-Fusion Addon License, EPAL v 1.0.</h2>
<h3>Terms and Conditions</h3>
<ul>
	<li><strong>This license</strong> refers to Enduser PHP-Fusion Addon License, EPAL (v1.0).</li>
	<li>Each licensor is referred to as <strong>You</strong> or <strong>Licensor</strong>.</li>
	<li><strong>Licensees</strong>, <strong>recipients</strong> and similar may be individuals or organizations.</li>
	<li><strong>Licensor</strong> is the copyright holder of the Addon for which this License is intended and that Addon and Licensor alone.</li>
</ul>
<br />
...
<ol>
	...
	<li>By purchasing this license you accept this License in it's full or you don't use this software under this License, perhaps your needs are better met under one of our other Licenses, (see links at bottom of document).</li>
</ol>
<h3>4. Definitions.</h3>
<ul>
	<li><strong>Licensed Software</strong> means a complete and unchanged copy of the release version of the software product ordered by Licensee through Licensor (or other party authorized by the Licensor).</li>
	<li><strong>Licensed Copy</strong> means one copy of the Licensed Software for each license purchased.</li>
	<li><strong>Per Website Basis</strong> means a license which limits installation and operation of each Licensed Copy to a Single Website.</li>
	<li><strong>Single Website</strong> means up to three defined site access configurations that may consist of one site access for public use, one site access for internal use (such as an intranet) and one site access for site administrator use. Additional terms may be defined in other sections of this License.</li>
	<li>All of these Licenses must however remain under the same domain, meaning, that the internal and administration use of this software must be on the same domain under which the License is purchased.</li>
</ul>
<br />
...
<h3>14.6 U.S. Government Restricted Rights.</h3>
...
<?php
echo $locale['pla_006']."<a target='_blank' href='".INFUSIONS."license_admin/print/epal.txt' title='".$locale['global_075']."'><img src='".get_image("printer")."' alt='".$locale['global_075']."' style='vertical-align:middle;border:0;' /></a>\n";
echo "</td>\n</tr>\n</table>\n";
closetable();
echo "</div>";
