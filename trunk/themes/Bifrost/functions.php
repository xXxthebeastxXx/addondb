...
<?php endif ?>
        ...
        <li><a href="/messages.php"<?php echo $msg_count ? " title='".sprintf($locale['global_125'], $msg_count).($msg_count == 1 ? $locale['global_126'] : $locale['global_127'])."'" : ""; ?>><?php echo $msg_count ? "Messages <br />You got $msg_count new" : "Messages"; ?></a>
