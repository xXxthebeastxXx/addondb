...
app_company_name VARCHAR(200) NOT NULL, 
app_company_address TEXT NOT NULL, 
app_company_phone VARCHAR(100) NOT NULL, 
app_vat VARCHAR(200) NOT NULL,
app_bill_name VARCHAR(200) NOT NULL,
app_bill_email VARCHAR(100) NOT NULL,
app_tech_name VARCHAR(200) NOT NULL,
app_tech_email VARCHAR(100) NOT NULL,
