...
add_to_title($locale['global_200'].$locale['pla_001'].$locale['global_200'].$locale['pla_107']);
...
opentable($locale['pla_107']);
echo "<div class='grid_15 alpha omega'>";
echo "<table class='tbl-border'>\n<tr>\n";
echo "<td class='tbl1' valign='top'>\n";
?>

<p>IMPORTANT: THE SOFTWARE IS LICENSED, NOT SOLD. Please read the following License Agreement ("License") carefully. This License is between PHP-Fusion, copyright Nick Jones, Wales ("Licensor"), and the customer ("Licensee" OR "YOU"). BY INSTALLING ALL OR ANY PORTION OF THE SOFTWARE (OR AUTHORIZING ANY OTHER PERSON TO DO SO) , YOU ACCEPT ALL THE TERMS AND CONDITIONS OF THIS LICENSE. IF YOU ACQUIRED THE SOFTWARE WITHOUT AN OPPORTUNITY TO REVIEW THIS LICENSE AND DO NOT ACCEPT THE LICENSE, YOU MAY OBTAIN A REFUND OF THE AMOUNT YOU ORIGINALLY PAID FOR THE SOFTWARE IF YOU: (A) DO NOT USE THE SOFTWARE AND (B) RETURN THE SOFTWARE, WITH PROOF OF PAYMENT, WITHIN THIRTY (30) DAYS OF THE PURCHASE DATE.</p>
<h2>PHP-Fusion Commercial Core License, (CCL) v1.0</h2>
...
<h3>1. Definitions.</h3>
<ul>
	<li><strong>Licensed Software</strong> means a complete and unchanged copy of the released version of the software product ordered by Licensee through Licensor (or parties authorized by the Licensor).</li>
...
<br />
<p>Licensor is PHP-Fusion, copyright Nick Jones, 27 Monger Rd, Wrexham,LL13 8QY, UK.</p>
...
<h3>3. Restrictions/No Support.</h3>
...
<h3>11.5 Export Law Assurances.</h3>
...
<h3>11.6 U.S. Government Restricted Rights.</h3>
...
echo $locale['pla_006']."<a target='_blank' href='".INFUSIONS."license_admin/print/ccl.txt' title='".$locale['global_075']."'><img src='".get_image("printer")."' alt='".$locale['global_075']."' style='vertical-align:middle;border:0;' /></a>\n";
echo "</td>\n</tr>\n</table>\n";
closetable();
echo "</div>";
